...
```qml
<!-- @include: src/positioners/RedSquare.qml#global -->
```
...
```qml
<!-- @include: src/positioners/ColumnExample.qml#global -->
```
...
```qml
<!-- @include: src/positioners/RowExample.qml#global -->
```
...
```qml
<!-- @include: src/positioners/GridExample.qml#global -->
```
...
```qml
<!-- @include: src/positioners/FlowExample.qml#global -->
```
...
```qml
<!-- @include: src/positioners/RepeaterExample.qml#global -->
```
