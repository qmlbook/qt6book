...
```qml
<!-- @include: src/basic/main.qml#global -->
```
...
```qml
<!-- @include: src/basic/basic.py#global -->
```
...
```qml
<!-- @include: src/class-context-property/class.py#number-generator -->
```
...
```qml
<!-- @include: src/class-context-property/class.py#main -->
```
...
```qml
<!-- @include: src/class-context-property/main.qml#global -->
```
...
```qml
<!-- @include: src/property/property.py#main -->
```
...
```qml
<!-- @include: src/property/main.qml#global -->
```
...
```qml
<!-- @include: src/class-registered-type/class.py#global -->
```
...
```qml
<!-- @include: src/class-registered-type/main.qml#global -->
```
...
```qml
<!-- @include: src/model/model.py#global -->
```
...
```qml
<!-- @include: src/model/main.qml#global -->
```
