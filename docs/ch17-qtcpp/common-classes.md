...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M1 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M2 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M3 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M4 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M5 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M6 -->
```
...
```qml
<!-- @include: src/qtfoundation/tst_foundation.cpp#M7 -->
```
