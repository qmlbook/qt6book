...
```qml
<!-- @include: src/camera-capture/complete.qml#viewfinder -->
```
...
```qml
<!-- @include: src/camera-capture/complete.qml#model-view -->
```
...
```qml
<!-- @include: src/camera-capture/complete.qml#button-shot -->
```
...
```qml
<!-- @include: src/camera-capture/complete.qml#capture-session{6-8} -->
```
...
```qml
<!-- @include: src/camera-capture/complete.qml#switching-devices{1-3,11} -->
```
...
```qml
<!-- @include: src/camera-capture/complete.qml#playback -->
```
