...
```qml
<!-- @include: src/cppintegration/counter.h#global -->
```
...
```qml
<!-- @include: src/cppintegration/CMakeLists.txt#generate_interfaces -->
```
...
```qml
<!-- @include: src/cppintegration/counter.cpp#ctor -->
```
...
```qml
<!-- @include: src/cppintegration/counter.cpp#incdec -->
```
...
```qml
<!-- @include: src/cppintegration/counter.cpp#reset -->
```
...
```qml
<!-- @include: src/cppintegration/cppintegration.qml#left -->
```
...
```qml
<!-- @include: src/cppintegration/cppintegration.qml#right -->
```
