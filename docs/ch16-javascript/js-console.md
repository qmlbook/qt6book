...
### Application window
```qml
<!-- @include: src/JSConsole/JSConsole.qml#application-window -->
```
...
```qml
<!-- @include: src/JSConsole/JSConsole.qml#import -->
```

```qml
<!-- @include: src/JSConsole/JSConsole.qml#js-call -->
```
...
```qml
<!-- @include: src/JSConsole/jsconsole.js#global -->
```
