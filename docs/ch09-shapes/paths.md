...
```qml
<!-- @include: src/shapes/paths.qml#line -->
```
...
```qml
<!-- @include: src/shapes/paths.qml#polyline -->
```
...
```qml
<!-- @include: src/shapes/paths.qml#arc -->
```
...
```qml
<!-- @include: src/shapes/paths.qml#quad -->
```
...
```qml
<!-- @include: src/shapes/paths.qml#cubic -->
```
...
```qml
<!-- @include: src/shapes/paths.qml#curve -->
```
