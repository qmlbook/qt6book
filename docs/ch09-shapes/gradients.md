...
```qml
<!-- @include: src/shapes/fillmode.qml#oddeven -->
```
```qml
<!-- @include: src/shapes/fillmode.qml#winding -->
```
...
```qml
<!-- @include: src/shapes/gradients.qml#solid -->
```
...
```qml
<!-- @include: src/shapes/gradients.qml#linear -->
```
...
```qml
<!-- @include: src/shapes/gradients.qml#conical -->
```
...
```qml
<!-- @include: src/shapes/gradients.qml#radial -->
```
