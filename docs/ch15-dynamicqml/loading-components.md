...
```qml
<!-- @include: src/loader/main.qml#M3 -->
```
...
```qml
<!-- @include: src/loader/main.qml#M1 -->
```
...
```qml
<!-- @include: src/connections/main.qml#M1 -->
```
...
```qml
<!-- @include: src/connections/main.qml#M2 -->
```
...
```qml
<!-- @include: src/connections/main.qml#M3 -->
```
...
```qml
<!-- @include: src/connections-parent/Flasher.qml#M1 -->
```

To use the `Flasher`, simply instantiate a Flasher within each MouseArea, and it all works.

```qml
<!-- @include: src/connections-parent/main.qml#M1 -->
```
