...
```qml
<!-- @include: src/repeater/number.qml#global -->
```
...
```qml
<!-- @include: src/repeater/array.qml#global -->
```
...
```qml
<!-- @include: src/repeater/model.qml#global -->
```
...
```qml
<!-- @include: src/repeater/delegate.qml#global -->
```
