...
```qml
<!-- @include: src/db-snippet/main.qml#global -->
```
...
```qml
<!-- @include: src/rectangle/main.qml#M1 -->
```
...
```qml
<!-- @include: src/rectangle/main.qml#M2 -->
```
...
```qml
<!-- @include: src/rectangle/main.qml#M4 -->
```
...
```qml
<!-- @include: src/rectangle/main.qml#M3 -->
```
