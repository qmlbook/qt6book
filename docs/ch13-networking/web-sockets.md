...
```qml
<!-- @include: src/ws/ws_server/server.js#global -->
```
...
```qml
<!-- @include: src/ws/ws_client/Label.qml#global -->
```
...
```qml
<!-- @include: src/ws/ws_client/ChatView.qml#global -->
```

The chat input is just a simple text input wrapped with a colored border.

```qml
<!-- @include: src/ws/ws_client/ChatInput.qml#global -->
```
...
```qml
<!-- @include: src/ws/ws_client/ws_client.qml#global -->
```
