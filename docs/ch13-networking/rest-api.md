...
```qml
<!-- @include: src/restservice/server.py#setup -->
```
```python
# Services registration & implementation...
```
```qml
<!-- @include: src/restservice/server.py#main -->
```
...
```qml
<!-- @include: src/restservice/server.py#get-colors -->
```
...
```qml
<!-- @include: src/restservice/server.py#get-color -->
```
...
```qml
<!-- @include: src/restservice/server.py#create-color -->
```
...
```qml
<!-- @include: src/restservice/server.py#update-color -->
```
...
```qml
<!-- @include: src/restservice/server.py#delete-color -->
```
...
```qml
<!-- @include: src/rest/colorservice.js#request -->
```
...
```qml
<!-- @include: src/rest/colorservice.js#services -->
```
...
```qml
<!-- @include: src/rest/rest.qml#import -->
```

Reading the color list from the server:

```qml
<!-- @include: src/rest/rest.qml#read-colors -->
```

Create a new color entry on the server:

```qml
<!-- @include: src/rest/rest.qml#create-color -->
```

Reading a color based on its name:

```qml
<!-- @include: src/rest/rest.qml#read-color -->
```

Update a color entry on the server based on the color name:

```qml
<!-- @include: src/rest/rest.qml#update-color -->
```

Delete a color by the color name:

```qml
<!-- @include: src/rest/rest.qml#delete-color -->
```
