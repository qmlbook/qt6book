...
```qml
<!-- @include: src/basicmaterials/main.qml#suzannedefault -->
```
...
```qml
<!-- @include: src/basicmaterials/main.qml#suzanneprincipled -->
```
...
```qml
<!-- @include: src/defaultmaterial/main.qml#middle -->
```
...
```qml
<!-- @include: src/principledmaterial/main.qml#middle -->
```
...
```qml
<!-- @include: src/basicmaterials/main.qml#skybox -->
```
