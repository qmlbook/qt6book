...
```qml
<!-- @include: src/particles/age.qml#M1 -->
```
...
```qml
<!-- @include: src/particles/attractor.qml#M1 -->
```
...
```qml
<!-- @include: src/particles/friction.qml#M1 -->
```
...
```qml
<!-- @include: src/particles/gravity.qml#M1 -->
```
...
```qml
<!-- @include: src/particles/turbulence.qml#M1 -->
```
...
```qml
<!-- @include: src/particles/wander.qml#M1 -->
```
